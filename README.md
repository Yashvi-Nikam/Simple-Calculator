...
- This project uses **XML** to manage calculation history during runtime
...
- Responsive enough to be usable on mobile devices
...
- **XML** – Storing calculation history during the session
